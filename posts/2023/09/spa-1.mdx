...
<Image src={`/assets/images/posts/spa-1/1.png`} alt={"js가 잘 로드된 모습"} />
...
<Image src={`/assets/images/posts/spa-1/2.gif`} alt={"각 url 마다 찍히는 콘솔"} />
...
<Collapsible summary={"history.pushState란?"}>
  ...
  <Image src={`/assets/images/posts/spa-1/3.png`} alt={"unused 설명"} />
  3) url
  브라우저 주소창에 표시될 URL
